...
class UnitTests(unittest.TestCase):
    def setUp(self):
        self.rect = shape_area.Rectangle(3, 6)
        self.sq = shape_area.Square(5)

    def test_subclass(self):
        actual = issubclass(shape_area.Square, shape_area.Rectangle)
        expected = True
        self.assertEqual(actual, expected, 'Expected Square class to be a subclass of the Rectangle class.')

    def test_distinct_classes(self):
        actual = shape_area.Square is not shape_area.Rectangle
        expected = True
    ...
    def test_square_is_square_and_rectangle(self):
        actual = isinstance(self.sq, shape_area.Square) and isinstance(self.sq, shape_area.Square)
        expected = True
    ...
    def test_get_amount_inside_two_rectangles(self):
        rect2 = shape_area.Rectangle(4, 8)
    ...
    def test_get_amount_inside_none(self):
        rect2 = shape_area.Rectangle(2, 3)
        actual = rect2.get_amount_inside(self.rect)
        expected = 0
